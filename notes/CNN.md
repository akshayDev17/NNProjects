...
1. [Andrew-NG](#resource1):
   ...
   11. [Lecture-13 : Classic CNNs](#res1lec13)
       1. [LeNet5](#lec13n1)
       2. [AlexNet](#lec13n2)
       3. [VGG-16](#lec13n3)
...
## Lecture-13 : Classic CNNs<a name="res1lec13"></a>

### LeNet - 5<a href="lec13n1"></a>
...
had a complicated way of training on 2-GPUs since at that time(2014), GPUs were new and slower, layers asplit across 2-gpus, gpus then communicate with each other. 
